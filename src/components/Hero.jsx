            ...
            <div className="h-[68vh] md:h-[72vh] bg-cover bg-center" style={{ backgroundImage: `url(${HERO})` }}>
                <div className="backdrop-brightness-75 h-full flex items-center">
                    <div className="max-w-6xl mx-auto px-6 text-white">
                        ...
                        <p className="mt-4 max-w-2xl text-lg">L'eleganza intangibile su misura che non passa inosservata. Le piscine naturali Rocks Design si adattano perfettamente all'ambiente circostante. Rispetto alle classiche piscine, non esiste un catalogo: l'opera viene realizzata da Luna Costruzioni in base alla morfologia del tuo giardino, come un vestito su misura.</p>
                        <div className="mt-6">
