...
export default function AzioniRapide() {
    return (
        <div className="pointer-events-none fixed inset-x-0 bottom-0 z-40 sm:inset-x-auto sm:bottom-6 sm:right-6">
            <div className="pointer-events-auto flex gap-2 border-t border-pietra-200 bg-sabbia-50/95 p-3 backdrop-blur sm:flex-col sm:items-end sm:border-0 sm:bg-transparent sm:p-0 sm:backdrop-blur-none">
                <a
                    ...
                    target="_blank"
                    rel="noopener"
                    className="flex flex-1 items-center justify-center gap-2 rounded-full bg-[#25D366] px-5 py-3 text-sm font-semibold text-white shadow-lg sm:flex-none"
                >
                ...
                <a
                    ...
                    className="flex flex-1 items-center justify-center gap-2 rounded-full bg-acqua-700 px-5 py-3 text-sm font-semibold text-white shadow-lg sm:flex-none"
                >
                    ...
                    <span className="hidden sm:inline">{AZIENDA.telefono}</span>
                </a>
            </div>
        </div>
    )
